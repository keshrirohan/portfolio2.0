...
export function Contact() {
  ...
  return (
    <section id="contact" className="py-24 border-t border-border/40 bg-secondary/10 relative">
      <div className="container max-w-4xl mx-auto px-4 md:px-6 flex flex-col items-center text-center">
        ...
        <Card className="w-full max-w-lg bg-card/60 backdrop-blur-md border-border/60 shadow-xl mb-10 overflow-hidden">
              ...
              <TooltipTrigger
                render={
                  <Button
                    ...
                    className="rounded-full gap-2 text-xs font-semibold px-4 w-full sm:w-auto"
                  >
                    {copied ? (
                      <>
        ...
        <div className="flex flex-wrap items-center justify-center gap-3 w-full max-w-md">
          <a
            ...
            className={cn(buttonVariants({ size: "lg" }), "rounded-full gap-2 px-6 font-semibold flex-1 min-w-[140px]")}
          >
          ...
          <a
            ...
            className={cn(buttonVariants({ size: "lg", variant: "outline" }), "rounded-full gap-2 px-6 font-semibold flex-1 min-w-[140px]")}
          >
