    ...
    <>
      ...
      >
        <div
          style={{
            ...
            height: "100%",
            borderRadius: "50%",
            border: `1.5px solid ${hovering ? "#ed722a" : "rgba(255,255,255,0.4)"}`,
            transform: clicking ? "scale(0.75)" : hovering ? "scale(1.5)" : "scale(1)",
            transition: "transform 0.2s, border-color 0.2s",
            background: hovering ? "rgba(237,114,42,0.05)" : "transparent",
          }}
        />
      </div>
      {/* Inner dot */}
      <div
        ...
        style={{
          ...
          height: 6,
          borderRadius: "50%",
          background: hovering ? "#ed722a" : "rgba(255,255,255,0.9)",
          opacity: visible ? 1 : 0,
